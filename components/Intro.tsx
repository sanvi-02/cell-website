    ...
    return (
        <section id="Intro" className="bg-white py-6 px-4 md:px-12 flex justify-center">
            <div className="relative max-w-86/100 rounded-[20px] bg-white min-h-[650px] flex items-center px-8 md:px-16 overflow-hidden">
                    ...
                    <div ref={statsRef} className="flex gap-16 mt-10">
                        ...
                        <div>
                            <h3 className="font-manrope font-[500] text-[30px]/[36px] md:text-[32px] text-[#333]">
                                {startCount ? (
                                    <CountUp end={30} duration={1800} suffix="+" />
                                ) : (
                                    "0+"
                                )}
                            </h3>
                        ...
                        <div>
                            <h3 className="font-manrope font-[500] text-[30px]/[36px] md:text-[32px] text-[#333]">
                                {startCount ? (
                                    <CountUp end={10} duration={1800} prefix="$" suffix="M+" />
                                ) : (
                                    "$0M+"
                                )}
                            </h3>
                ...
                {/* ================= RIGHT VISUAL ================= */}
                <div className="absolute right-0 top-0 hidden lg:block w-[52%] h-full">

                    {/* Large grey background card */}
                    <div className="absolute right-[6%] top-[5%] w-[78%] h-[70%] rounded-[22px] bg-[#F5F5F5] shadow-[0_20px_45px_rgba(0,0,0,0.08)]" />

                    {/* Website preview IMAGE */}
                    <div className="absolute z-10 right-[50%] bottom-[8%] w-[48%] rounded-[10px] overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.12)]">
                        <img src="/website_preview.png" alt="E-Cell IIT Roorkee website preview" className="block w-full h-auto" />
                    </div>
